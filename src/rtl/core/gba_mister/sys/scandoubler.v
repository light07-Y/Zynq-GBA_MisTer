...
reg ce_x4i, ce_x1i;
always @(posedge clk_vid) begin : x4_input_timing
	reg old_ce, valid, hs;
...
always @(posedge clk_vid) begin : line_sample
	if(ce_x1i) begin
...
reg ce_x4o, ce_x2o;
always @(posedge clk_vid) begin : x4_output_timing
	reg hs;
...
reg [3:0] vso;
reg [8:0] hbo;
always @(posedge clk_vid) begin : sd_output_timing
