...
architecture arch of gba_gpu is
   ...
   signal hblank_trigger_int   : std_logic := '0';
   signal vblank_trigger_int   : std_logic := '0';
begin 

   hblank_trigger <= hblank_trigger_int;
   vblank_trigger <= vblank_trigger_int;
