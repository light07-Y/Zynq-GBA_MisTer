...
architecture arch of gba_memorymux is
   ...
   signal sdram_read_addr_int : std_logic_vector(24 downto 0) := (others => '0');
...
begin 
   ...
   (
      ...
      mem_read_addr     => sdram_read_addr_int,
   ...
   begin
      if rising_edge(clk100) then
         ...
         if (sdram_read_done = '1') then
            if (sdram_read_addr_int(0) = '0') then
         ...
         if (sdram_read_done_1 = '1') then
            if (sdram_read_addr_int(0) = '1') then
