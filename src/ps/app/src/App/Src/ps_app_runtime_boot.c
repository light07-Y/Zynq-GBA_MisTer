...
static void PsAppRuntime_InitDefaults(PsAppRuntimeContext *ctx) {
    ...
    ctx->diag->log_ddr_enable = 0U;
    ctx->diag->reserved0 = 0U;
    ...
    ctx->diag->ddrlog_interval_ticks = PS_APP_DDRLOG_DEFAULT_INTERVAL_TICKS;
    ctx->diag->ddrlog_tick = 0U;
    ctx->diag->ddrlog_last_status1 = 0U;
    ctx->diag->ddrlog_last_pc = 0U;
    ctx->diag->ddrlog_last_mem = 0U;
    ctx->diag->ddrlog_last_dma = 0U;
    ctx->diag->ddrlog_last_err = 0U;
    ctx->diag->ddrlog_last_counts0 = 0U;
    ctx->diag->ddrlog_last_counts1 = 0U;
    ctx->diag->ddrlog_same_sample_count = 0U;
    ctx->diag->pc_guard_enable = (u8)((PS_APP_PC_GUARD_DEFAULT_ENABLE != 0U) ? 1U : 0U);
    ctx->diag->pc_guard_recovery_active = 0U;
    ctx->diag->pc_guard_audio_restore_pending = 0U;
    ctx->diag->pc_guard_reserved0 = 0U;
    ctx->diag->pc_guard_invalid_streak = 0U;
    ctx->diag->pc_guard_cooldown_ticks = 0U;
    ctx->diag->pc_guard_reset_hold_ticks = 0U;
    ctx->diag->pc_guard_recovery_count = 0U;
    ctx->diag->pc_guard_tick = 0U;
    ctx->diag->pc_guard_last_bad_pc = 0U;
    ctx->diag->pc_guard_last_bad_status1 = 0U;
    ctx->diag->pc_guard_last_bad_mem = 0U;
    ctx->diag->pc_guard_last_bad_dma = 0U;
    ctx->diag->pc_guard_last_trigger_tick = 0U;
